...
A regional analysis of the UK housing market, examining whether stronger regional employment is associated with higher house prices. Built in Excel using HML Land Registry and ONS public data, combined with XLOOKUP and analysed via pivot tables.
...
## Data & Method:
I combined two public datasets: HM Land Registry’s UK House Price Index (average house price and 12-month price growth by region, monthly) and ONS regional Labour Force Survey data (employment rate, aged 16-64, by region). Both were filtered to England’s 9 official regions and matched by date and region, covering March 2015 to present (1, 041 matched monthly records). The two datasets were merged in Excel using XLOOKUP then summarised by region using a pivot table.
